...
<span class="line"><span>    }</span></span>
<span class="line"><span>  ]</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="use-sdk-request" tabindex="-1">Use SDK request <a class="header-anchor" href="#use-sdk-request" aria-label="Permalink to &quot;Use SDK request&quot;">​</a></h2><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-It5zq" id="tab-NRLm90D" checked><label data-title="Python" for="tab-NRLm90D">Python</label><input type="radio" name="group-It5zq" id="tab-0hdSZdO"><label data-title="JavaScript" for="tab-0hdSZdO">JavaScript</label></div><div class="blocks"><div class="language-py vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">py</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> openai </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> AsyncOpenAI</span></span>
